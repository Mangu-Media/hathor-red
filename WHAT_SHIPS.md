...
Last updated: 2026-09-13 (dose-1.78 client duration guard on recordListening).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.78 (client duration guard on recordListening) |
