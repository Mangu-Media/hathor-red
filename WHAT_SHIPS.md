...
Last updated: 2026-09-13 (dose-1.80 client updatePlaybackState currentSongId guard).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.80 (client updatePlaybackState currentSongId guard) |
