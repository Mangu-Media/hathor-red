...
Last updated: 2026-09-14 (dose-1.84 client AI list limit guards + aiController toNonNegInt from streamToken).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.84 (client AI list limit guards + aiController streamToken import) |
