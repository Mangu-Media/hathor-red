...
Last updated: 2026-09-13 (dose-1.76 client positive-int id guard on stream/song).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.76 (client id guard on stream/song) |
