...
Last updated: 2026-09-14 (dose-1.81 client updatePlaybackState position/volume/speed/isPlaying guards).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.81 (client updatePlaybackState full numeric/boolean guards) |
