...
Last updated: 2026-09-13 (dose-1.79 client songCount + reorder songIds guards).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.79 (client AI songCount + reorder songIds guards) |
