...
Last updated: 2026-09-14 (dose-1.85 client createRoom maxListeners + isPublic guards).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.85 (client createRoom maxListeners + isPublic guards) |
