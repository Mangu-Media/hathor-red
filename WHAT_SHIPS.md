...
Last updated: 2026-09-14 (dose-1.82 client updatePlaybackState pitchShift/stemsConfig guards).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.82 (client updatePlaybackState full numeric/boolean + pitch/stems guards) |
