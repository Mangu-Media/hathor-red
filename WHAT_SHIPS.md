...
Last updated: 2026-09-14 (dose-1.87 client createRoom name guard).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.87 (client createRoom name guard) |
| 2 Account | Soft logout + profile path present |
| 3–5 | Routes/flags/rooms as prior |

## Next item

Optional multi-device live queue list (not claimed); Dose 2 polish if playback regressions appear; client generateAIPlaylist prompt non-empty guard.
