...
Last updated: 2026-09-13 (dose-1.77 client positive-int id guard on playlist/room/similar/recordListening).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.77 (client id guard on playlist/room/similar) |
