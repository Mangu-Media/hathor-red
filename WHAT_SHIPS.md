...
Last updated: 2026-09-14 (dose-1.83 client getSongs/getMySongs limit/offset guards).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.83 (client list pagination limit/offset guards) |
